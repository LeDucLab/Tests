...
if council == "Erstberatung" and person == "Kind":
    ...
    st.markdown("##### Geburtshintergrund, unsafe_allow_html=True")
    col1, col2, col3 = st.columns(3)
    ...
    st.markdown("###### Meilensteine der motorischen Entwicklung, unsafe_allow_html=True")
    col1, col2, col3 = st.columns(3)
    ...
    st.markdown("###### Soziale Entwicklung, unsafe_allow_html=True")
    col1, col2 = st.columns(2)
    Kita=col1.text_input("Kita/Schulbbesuch")
    Interaktion=col2.text_input("Interaktion mit Familie/Gleichaltrigen")
    st.markdown("###### Aktuelle Symptome und Beobachtungen, unsafe_allow_html=True")
    col1, col2, col3, col4 = st.columns(4)
    ...
    st.markdown("####### Bisherige Untersuchungen und Interventionen, unsafe_allow_html=True")
    col1, col2 = st.columns(2)
