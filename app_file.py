...
with tab1:
    ...
    if analysis == "Exom" and disease != "Marfan/EDS":
        ...
        Wir nahmen Ihnen beiden, Frau und Herr {Nachname}, bereits eine Blutprobe ab, um gegebenenfalls eine Segregationsanalyse oder eine Trio-Analyse durchführen zu können. Sie gaben uns dazu bereits Ihr schriftliches Einverständnis. Sobald die Befunde der genetischen Diagnostik vorliegen, werden wir Sie informieren und weiterführend Stellung nehmen."
