...
with tab1:
    ...
    ########################
        ...
        st.markdown("### Anamnese")
        default_text = """In Bezug auf die aktuelle Fragestellung wurden folgende Aspekte in der Anamnese erfasst:<br>
        - Schwangerschafts- und Geburtshintergrund: Geburtsart XX, Geburtstermin XX, Geburtsmaßen XX<br>
...
with tab2:
    ...
    ###########
    if Titel_2== "Herr":
        hello_line_2 = f"Sehr geehrter {Titel_2} {Name_2},"
    elif Titel_2 != "Herr":
        hello_line_2 = f"Sehr geehrte {Titel_2} {Name_2},"
...
with tab4:
    ...
    elif Beratung_4=="Befundbesprechung":
        befund_4=col4.selectbox("Befund Ergebnis", ["auffällig", "unauffällig", "VUS"], key="criteria_4")
